...
ShaderProgram* spDiffuse;
ShaderProgram* spSkybox;
ShaderProgram* spLightSource;
ShaderProgram* spBumpmapped;
ShaderProgram* spDiffuseR;
...
void initShaders() {
	...
	spDiffuse = new ShaderProgram("v_customDiffuse.glsl", NULL, "f_customDiffuse.glsl");
	spSkybox = new ShaderProgram("v_skybox.glsl", NULL, "f_skybox.glsl");
	spLightSource = new ShaderProgram("v_lightsource.glsl", NULL, "f_lightsource.glsl");
	spBumpmapped = new ShaderProgram("v_bumpmapped.glsl", NULL, "f_bumpmapped.glsl");
	spDiffuseR = new ShaderProgram("v_diffuseRewrite.glsl", NULL, "f_diffuseRewrite.glsl");
